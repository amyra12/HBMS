                    ...
                    children: [
                      Padding(
                        ...
                        child: ListView(
                          ...
                          children: [
                            if (bedStatusModel.selectedStatus.text != 'Carbolised'&& bedStatusModel.selectedStatus.text != 'Ready')
                              Container(
                                decoration: BoxDecoration(
                            ...
                            SizedBox(height: 10),
                            if (bedStatusModelW1GB2.selectedStatus.text != 'Carbolised' && bedStatusModelW1GB2.selectedStatus.text != 'Ready')
                              Container(
                                decoration: BoxDecoration(
                                  color: Colors.lightBlueAccent,
                                  border: Border.all(
